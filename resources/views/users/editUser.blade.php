        ...
        <div class="col-lg-12 col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    {!! Form::model($user, ['method' => 'POST','route' => ['users.EditUpdate', $user->id]]) !!}
                    <div class="">
                    ...
                    <div class="row row-sm mg-b-20" hidden>
                        <div class="col-lg-6">
                    ...
                    <div class="mg-t-30">
                        ...
                        <div class="col-lg-12 margin-tb">
                            <div class="pull-right">
                                <a class="btn btn-main-primary pd-x-20" href="{{ url('/home') }}">{{ trans('invoices.Back') }}</a>
