...
class RoleController extends Controller
{
    ...
    function __construct()
    {
        ...
        $this->middleware('permission:Permission.AddSection|Permission.AddProduct|Permission.AddAttachment',['only' => ['create','store']]);
        $this->middleware('permission:Permission.PermissionEdit|Permission.UserEdit|Permission.EditSection|Permission.EditProduct|Permission.PaymentStatusChange|Permission.InvoiceEdit', ['only' => ['edit','update']]);
        $this->middleware('permission:Permission.InvoiceDelete|Permission.DeleteProduct|Permission.ArchiveInvoice|Permission.DeleteSection|Permission.UserDelete|Permission.DeleteAttachment|Permission.PermissionDelete', ['only' => ['destroy']]);
    }
